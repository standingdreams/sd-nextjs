...
<div className="blog__toc">
  ...
  <ul>
    ...
    <li><Link class="current" href="/writings/heroku-vs-digitalocean/deploying-to-heroku">Part 5: Deploy to Heroku</Link></li>
  </ul>
</div>
    ...
    <div className="container">
      <div className="blog">
        <header className="blog__header">
          <p className="blog__date">September 18, 2019</p>
          <h1 className="blog__heading">Heroku vs DigitalOcean: Deploying to Heroku</h1>
        </header>
