...
<div className="blog__toc">
  ...
  <ul>
    <li><Link class="current" href="/writings/heroku-vs-digitalocean/an-experiment-in-the-making">Part 1: An Experiment in the Making</Link></li>
    ...
    <div className="container">
      <div className="blog">
        <header className="blog__header">
          <p className="blog__date">February 22, 2018</p>
          <h1 className="blog__heading">Heroku vs DigitalOcean: An Experiment in the Making</h1>
        </header>
