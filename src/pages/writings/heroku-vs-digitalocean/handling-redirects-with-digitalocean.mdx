...
<div className="blog__toc">
  ...
  <ul>
    <li><Link href="/writings/heroku-vs-digitalocean/an-experiment-in-the-making">Part 1: An Experiment in the Making</Link></li>
    <li><Link href="/writings/heroku-vs-digitalocean/getting-started-with-digitalocean">Part 2: Getting Started with DigitalOcean</Link></li>
    <li><Link class="current" href="/writings/heroku-vs-digitalocean/handling-redirects-with-digitalocean">Part 3: Handling Redirects with DigialOcean</Link></li>
    <li><Link href="/writings/heroku-vs-digitalocean/the-experiment-continues">Part 4: The Experiment Continues</Link></li>
    <li><Link href="/writings/heroku-vs-digitalocean/deploying-to-heroku">Part 5: Deploy to Heroku</Link></li>
  </ul>
</div>
    ...
    <div className="container">
      <div className="blog">
        <header className="blog__header">
          <p className="blog__date">March 01, 2018</p>
          <h1 className="blog__heading">Heroku vs DigitalOcean: Handling Redirects with DigitalOcean</h1>
        </header>
