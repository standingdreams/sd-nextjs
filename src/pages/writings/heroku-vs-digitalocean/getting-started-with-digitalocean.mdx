...
<div className="blog__toc">
  ...
  <ul>
    ...
    <li><Link class="current" href="/writings/heroku-vs-digitalocean/getting-started-with-digitalocean">Part 2: Getting Started with DigitalOcean</Link></li>
    <li><Link href="/writings/heroku-vs-digitalocean/handling-redirects-with-digitalocean">Part 3: Handling Redirects with DigialOcean</Link></li>
    ...
    <div className="container">
      <div className="blog">
        <header className="blog__header">
          <p className="blog__date">February 28, 2018</p>
          <h1 className="blog__heading">Heroku vs DigitalOcean: Getting Started with DigitalOcean</h1>
        </header>
