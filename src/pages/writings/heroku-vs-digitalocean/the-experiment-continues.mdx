...
<div className="blog__toc">
  ...
  <ul>
    ...
    <li><Link class="current" href="/writings/heroku-vs-digitalocean/the-experiment-continues">Part 4: The Experiment Continues</Link></li>
    ...
    <div className="container">
      <div className="blog">
        <header className="blog__header">
          <p className="blog__date">April 04, 2019</p>
          <h1 className="blog__heading">Heroku vs DigitalOcean: The Experiment Continues</h1>
        </header>
