---
slug: "heroku-vs-digitalocean-getting-started-with-digitalocean"
date: "2018-02-28"
title: "Heroku vs DigitalOcean: Getting Started with DigitalOcean"
filename: "Heroku vs DigitalOcean - Getting Started with DigitalOcean.mdx"
---
  ...
  <ul>
    ...
    <li>
      <Link href="/writings/heroku-vs-digitalocean-getting-started-with-digitalocean">
        <a class="current">Part 2: Getting Started with DigitalOcean</a>
      </Link>
    </li>
    <li>
      <Link href="/writings/heroku-vs-digitalocean-handling-redirects-with-digitalocean">
        <a>Part 3: Handling Redirects with DigialOcean</a>
      </Link>
    </li>
    <li>
